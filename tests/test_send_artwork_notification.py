...
class TestSendArtworkNotification:
    ...
    @patch('lambda_function.ssm')
    def test_send_notification_success(self, mock_ssm, mock_ses, mock_get_user_email):
    ...
    @patch('lambda_function.ses')
    @patch('lambda_function.ssm')
    def test_send_notification_configuration_set(self, mock_ssm, mock_ses, mock_get_user_email):
        ...
        call_args = mock_ses.send_templated_email.call_args
        assert call_args[1]['ConfigurationSetName'] == 'test-configuration-set'
